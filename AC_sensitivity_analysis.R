...
nspore <-data.frame(readRDS('diet_scores_data_820_notimputed.rds'))
...
write.csv(fin.results,'sensitivity_results_table_905.csv')
write.table(fin.results,"sensitivity_results_table_905.txt",sep=",",row.names=FALSE)
