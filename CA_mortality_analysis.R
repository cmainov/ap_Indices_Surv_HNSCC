...
# redo death/censor variable for cause-specific death
nspore<-nspore%>%
...
write.csv(fin.results,'ca_main_results_table_903.csv')
write.table(fin.results,"ca_main_results_table_903.txt",sep=",",row.names=FALSE)
...
saveRDS(comb.surv.data,'data_long_list_ca.rds')

### survival plots
survplots_ca<-do.call('ggarrange',comb.surv.plots)
